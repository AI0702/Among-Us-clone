...
* [TomPrograms](https://github.com/TomPrograms) for his [project](https://github.com/TomPrograms/Python-Voice-Chat), used as a base for the voice chat functionality.
